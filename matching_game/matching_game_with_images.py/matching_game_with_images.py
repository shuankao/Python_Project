...
image = Image.open('C:/Users/hsuan/Desktop/python_prac/matching_game/images/card_back.jpg')
...
def shuffle():
    for i in range(10):
        image = Image.open('C:/Users/hsuan/Desktop/python_prac/matching_game/images/image'+str(i+1)+'.png')
        img = image.resize((100,100))
